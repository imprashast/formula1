        ...
        return (
            <Router history={hashHistory}>
                <Route path='/' component={Container}>
                    ...
                    <Route path='year' component={FullRace}>
                        <IndexRoute components={{ yearconst: Yearconst, raceFetch: RaceFetch }} />
                    </Route>
...
const Nav = () => (
    <div>
        ...
        <IndexLink activeClassName='active' to='/year'>Year</IndexLink>&nbsp;
